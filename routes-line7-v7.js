  ...
  const routes = {
    ...
    line7: {
      ...
      events: [
        ...
        {
          id: "line7-left-turn-lucaibei",
          title: "左转弯到芦蔡北路",
          detail: "斑马线停车，打左转灯左转到芦蔡北路；通过路口保持30码以下并有明显踩刹车动作。",
          voice: "前方路口请左转",
          rule: "stop",
          turnSignal: "left",
          countdown: true,
          manual: true,
          tags: ["斑马线停车", "左转灯", "限速30", "踩刹"]
        },
        {
          id: "line7-huanan-straight",
          title: "路口直行",
          detail: "路口(华南路)斑马线停车；通过路口保持30码以下并有明显踩刹车动作。",
          rule: "stop",
          manual: true,
          tags: ["华南路", "斑马线停车", "限速30", "踩刹"]
        },
        {
          id: "line7-school",
          title: "学校区域",
          detail: "学校30米感应区速度不要超过30，并有明显踩刹车动作。",
          rule: "maxSpeed30",
          radius: 60,
          manual: true,
          tags: ["学校", "限速30", "踩刹"]
        },
        {
          id: "line7-bus-stop-1",
          title: "公交站停车",
          detail: "公交站必须停车；通过公交站保持30码以下并有明显踩刹车动作。",
          rule: "stop",
          manual: true,
          tags: ["公交站", "停车", "限速30", "踩刹"]
        },
        {
          id: "line7-huawei-uturn",
          title: "华卫路掉头",
          detail: "经过路口(华卫路)斑马线停车，同时打左转灯掉头；打灯后保持方向盘不动3秒。",
          voice: "前方路口请掉头",
          rule: "stop",
          turnSignal: "left",
          countdown: true,
          manual: true,
          tags: ["华卫路", "斑马线停车", "左转灯", "掉头"]
        },
        {
          id: "line7-bus-stop-2",
          title: "公交站停车",
        ...
        },
        {
          id: "line7-overtake",
          title: "超车",
          detail: "打左转灯超车，打右转灯回原车道；之后经过路口(华南路)斑马线停车。",
          voice: "前方请完成超车",
          completionVoice: "已完成",
          rule: "stop",
          turnSignal: "left",
          countdown: true,
          manual: true,
          tags: ["超车", "左转灯", "右转灯", "华南路停车"]
        },
        {
          id: "line7-right-turn",
          title: "右转弯",
          detail: "打右转灯右转；打灯后保持方向盘不动3秒，通过路口保持30码以下并有明显踩刹车动作。",
          voice: "前方路口请右转",
          turnSignal: "right",
          countdown: true,
          manual: true,
        ...
        {
          id: "line7-lane-change-left",
          title: "变道",
          detail: "打左转灯变到左面车道；打灯后保持方向盘不动3秒。",
          voice: "请开始变更车道",
          turnSignal: "left",
          countdown: true,
          manual: true,
        ...
        {
          id: "line7-straight-accel",
          title: "直线加速行驶",
          detail: "速度在40-60之间；速度到达40后计时5秒，5秒内低于40或超过60扣10分。",
          voice: "请开始直线行驶",
          completionVoice: "已完成",
          rule: "accelerationStrict",
          radius: 60,
          manual: true,
          tags: ["40-60", "5秒", "扣10分"]
        },
        {
          id: "line7-xinxie-uturn",
          title: "新协路掉头",
          detail: "打左转灯，路口(新协路)斑马线停车后掉头；打灯后保持方向盘不动3秒。",
          voice: "前方路口请掉头",
          rule: "stop",
          turnSignal: "left",
          countdown: true,
          manual: true,
          tags: ["新协路", "斑马线停车", "左转灯", "掉头"]
        },
        {
          id: "line7-pull-over",
          title: "靠边停车",
          detail: "打右转灯靠边停车，距离边线30-50cm；打灯后保持方向盘不动3秒。",
          voice: "请靠边停车",
          turnSignal: "right",
          countdown: true,
          manual: true,
          tags: ["右转灯", "靠边30-50cm", "手动确认"]
        }
      ]
    }
  };
